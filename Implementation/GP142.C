...
{
	COLORREF c = GetPixel (offscreen_DC,gXCenter+x,gYCenter-y);
	if (c==0)				return	BLACK;		//	0
	else if (c==16777215)	return	WHITE;		//	1
	else if (c==255)		return	RED;		//	2
	else if (c==65280)		return	GREEN;		//	3
	else if (c==16711680)	return	BLUE;		//	4
	else if (c==65535)		return	YELLOW;		//	5
	else if (c==16711935)	return	MAGENTA;	//	6
	else if (c==16776960)	return	CYAN;		//	7
	else if (c==13369497)	return	PURPLE;		//	8
	else if (c==10040064)	return	NAVY_BLUE;	//	9
	else if (c==10053273)	return	DUSTY_PLUM;	//	10
	else if (c==16777113)	return	ICE_BLUE;	//	11
	else if (c==13434777)	return	TURQUOISE;	//	12
	else if (c==26367)		return	ORANGE;		//	13
	else if (c==3368601)	return	BROWN;		//	14
	else if (c==13408767)	return	PINK;		//	15
	else if (c==10092543)	return	CHALK;		//	16
	else if (c==3381708)	return	GOLD;		//	17
	else if (c==6724095)	return  PEACH;		//	18
	else if (c==3368448)	return  FOREST_GREEN;//	19
	else if (c==10079283)	return  SEA_GREEN;	//	20
	else if (c==3381657)	return  OLIVE;		//	21
	else if (c==8421504)	return  MED_GRAY;	//	22
	else if (c==13421772)	return  LT_GRAY;	//	23
	return c;
}
#elif defined(X11R6)
